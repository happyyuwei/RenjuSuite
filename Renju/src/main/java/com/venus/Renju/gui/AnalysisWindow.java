...
public class AnalysisWindow extends Window {
     ...
     * @param mode
     */
    public AnalysisWindow(String mode) {
        super("走棋分析-" + mode);
     ...
     */
    public void init() {
        //initial board visual
        this.board_panel.updateBoard();
        //启动游戏
        if (this.mode.equals(AnalysisWindow.MODE_AI)) {
            //model
    ...
    public void startGame() {
        ...
        if (rand > 0.5) {
            ...
            //玩家是白棋
            this.player_id = this.board_panel.referee.getWhite_id();
            //ai 黑棋
    ...
    public void aiTurn() {
        ...
        //走棋
        this.board_panel.referee.turn(ai_p, this.ai_id);
        //刷新
        this.board_panel.fresh();
    }
